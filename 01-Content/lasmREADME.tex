...
%
 ...
 \begin{figure}[htb]
 	...
 	\begin{minipage}[c][0.525\textwidth][c]{0.70\textwidth} 	% 0.60 x 3/4 = 0.45
 		% Height and width should be adjusted to the figure aspect ratio
 		% In this case the figure is 3/4, hence 
 		\includegraphics[width=\linewidth]{\GraficPath Schall_Messtechnik}
 	\end{minipage}
 	%
 	\hfil%
 	% RIGHT MINIPAGE WITH TWO FIGURES
 	\begin{minipage}[c][0.525\textwidth][c]{0.25\textwidth}  % same height as left minipage chosen --> 0.525
 		\includegraphics[width=\linewidth]{\GraficPath Schall_Messtechnik}%
 		\\
 		\vfill
 		\includegraphics[width=\linewidth]{\GraficPath Schall_Messtechnik}
 ...
 \begin{figure}[htb]
 	...
 	{\includegraphics[width=0.4\linewidth]{\GraficPath Logo-NawaRo} }
...
% 	\includesvg[width=\fwidth]{\GraficPath Example-svg}
...
% 	\centering
% 	\setlength\fwidth{0.7\textwidth}
% 	\includesvg[angle=15,width=\fwidth]{\GraficPath Example-svg}
...
% 	\centering
% 	\begin{annotate}
% 		{\includegraphics[width=0.4\textwidth]{\GraficPath Logo-THRo}}{0.4}
% 		%\helpgrid
...
% \end{figure}
 ...
 \begin{figure}[htb]
 	...
 	%\centering                          % Zentrieren des Bildes
 	\input{\GraficPath Example-TL-plot.tikz}
